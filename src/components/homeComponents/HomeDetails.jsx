...
const HomeDetails = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_APP_API_ENDPOINT}/api/store/count-products`,
        {
          headers: {
  ...
  useEffect(() => {
    axios
      .get(
        `${import.meta.env.VITE_APP_API_ENDPOINT}/api/store/order-pending-count`
      )
      .then((response) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_APP_API_ENDPOINT}/api/public/total-customers`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
